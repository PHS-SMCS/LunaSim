    ...
    */
    safeEval(expression) {
        ...
        expression = expression
            ...
            .replaceAll(/(?<!Math\.)\bmax\b/gi, 'Math.max')
            .replaceAll(/(?<!Math\.)\bmin\b/gi, 'Math.min')
            .replaceAll(/(?<!Math\.)\bsignum\b/gi, 'Math.signum')
            .replaceAll(/(?<!Math\.)\btoRadians\b/gi, 'Math.toRadians')
            .replaceAll(/(?<!Math\.)\btoDegrees\b/gi, 'Math.toDegrees')
            ...
            .replaceAll(/(?<!Math\.)\bcopySign\b/gi, 'Math.copySign')
            .replaceAll(/(?<!Math\.)\bnextUp\b/gi, 'Math.nextUp')
            .replaceAll(/(?<!Math\.)\bnextDown\b/gi, 'Math.nextDown')
            .replaceAll(/(?<!Math\.)\bulp\b/gi, 'Math.ulp')
            .replaceAll(/(?<!Math\.)\bIEEEremainder\b/gi, 'Math.IEEEremainder')
            .replaceAll(/(?<!Math\.)\brint\b/gi, 'Math.rint')
            .replaceAll(/(?<!Math\.)\bgetExponent\b/gi, 'Math.getExponent')
            .replaceAll(/(?<!Math\.)\bscalb\b/gi, 'Math.scalb')
            .replaceAll(/(?<!Math\.)\bfma\b/gi, 'Math.fma')
            .replaceAll(/(?<!Math\.)\btan2\b/gi, 'Math.tan2')
